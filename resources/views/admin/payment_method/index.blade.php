...
@section('content')
            ...
            <div class="flex flex-col md:flex-row gap-2 text-xs md:text-sm">
                ...
                <div class="md:w-1/3 w-full">
                    <select id="searchchannel" name="searchchannel"
                        ...
                        <option value="1" {{ request('searchchannel') === '1' ? 'selected' : '' }}>Cash</option>
                        <option value="2" {{ request('searchchannel') === '2' ? 'selected' : '' }}>Check</option>
                        <option value="3" {{ request('searchchannel') === '3' ? 'selected' : '' }}>Bank Transfer
                        </option>
                        <option value="4" {{ request('searchchannel') === '4' ? 'selected' : '' }}>Credit Card</option>
                        <option value="5" {{ request('searchchannel') === '5' ? 'selected' : '' }}>Debit Card</option>
                        <option value="6" {{ request('searchchannel') === '6' ? 'selected' : '' }}>Online Payment
                        </option>
                        <option value="7" {{ request('searchchannel') === '7' ? 'selected' : '' }}>Digital Wallet
                        </option>
                        <option value="8" {{ request('searchchannel') === '8' ? 'selected' : '' }}>Other</option>
                    </select>
                </div>
            ...
            <table class="min-w-full text-xs">
                <thead class="bg-gray-200 text-gray-600">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3 text-left w-[100px]">Channel</th>
                ...
                <tbody class="divide-y">
                    @forelse($paymentMethods as $method)
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3 w-[80px]">{{ $method->code }}</td>
                            <td class="px-4 py-3 w-[150px]">{{ $method->name }}</td>
                            <td class="px-4 py-3 w-[200px]">{{ $method->description }}</td>
                            @php
                                $channels = [
                                    '1' => 'Cash',
                                    '2' => 'Check',
                            ...
                            @endphp
                            <td class="px-4 py-3 w-[100px]">{{ $channels[$method->payment_channel] ?? 'Unknown' }}</td>
                            ...
                            <td class="px-4 py-3 w-[50px]">
                                <div class="flex items-center justify-center space-x-2">
                                    <button type="button" title="Edit payment method: {{ $method->name }}"
                                        data-modal-target="edit-modal" data-modal-toggle="edit-modal"
                                        data-id="{{ $method->id }}" data-name="{{ $method->name }}"
                                        data-code="{{ $method->code }}" data-description="{{ $method->description }}"
                                        data-requires_bank="{{ $method->requires_bank }}"
                                        data-requires_check="{{ $method->requires_check }}"
                                        data-requires_reference_no="{{ $method->requires_reference_no }}"
                                        data-allow_partial_payment="{{ $method->allow_partial_payment }}"
                                        data-channel="{{ $method->payment_channel }}" data-status="{{ $method->status }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-6 text-center text-gray-500">
                                <img src="{{ asset('images/payment-method.svg') }}" alt="No data"
                                    class="mx-auto mb-4 w-24 h-28">
                                No payment methods found. Click here to <a href="#" data-modal-target="add-modal"
                        ...
                        <div class="grid ml-1 mr-1 gap-2 mb-4 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea type="text" name="description" id="description" rows="3" maxlength="255"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-gray-600 focus:border-gray-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
                                    placeholder="e.g. Cash payment method"></textarea>
                            </div>

                            <div class="md:col-span-1">
                                <label for="requires_bank"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Requires Bank
                                    Information*</label>
                                <select id="requires_bank" name="requires_bank"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
                                    required>
                            ...
                            <div class="md:col-span-1">
                                <label for="requires_check"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Requires Check
                                    Information*</label>
                                <select id="requires_check" name="requires_check"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
                                    required>
                                    <option value="1">Yes</option>
                                    <option value="0">No</option>
                            ...
                            <div class="md:col-span-1">
                                <label for="requires_reference_no"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Requires Reference
                                    Number*</label>
                                <select id="requires_reference_no" name="requires_reference_no"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
                                    required>
                                    <option value="1">Yes</option>
                                    <option value="0">No</option>
                            ...
                            <div class="md:col-span-1">
                                <label for="allow_partial_payment"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Allow Partial
                                    Payment*</label>
                            ...
                            <div class="md:col-span-1">
                                <label for="payment_channel"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Channel*</label>
                ...
                <div class="overflow-y-auto max-h-[70vh]">
                    <form id="editForm" class="p-4 md:p-5" method="POST">
                        ...
                        <div class="grid ml-1 mr-1 gap-2 mb-4 sm:grid-cols-2">
                            ...
                            <div class="md:col-span-1">
                                <label for="edit_requires_bank"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Requires Bank
                                    Information*</label>
                                <select id="edit_requires_bank" name="edit_requires_bank"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
                                    required>
                                    <option value="1">Yes</option>
                                    <option value="0">No</option>
                            ...
                            <div class="md:col-span-1">
                                <label for="edit_requires_check"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Requires Check
                                    Information*</label>
                                <select id="edit_requires_check" name="edit_requires_check"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
                                    required>
                                    <option value="1">Yes</option>
                                    <option value="0">No</option>
                            ...
                            <div class="md:col-span-1">
                                <label for="edit_requires_reference_no"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Requires Reference
                                    Number*</label>
                                <select id="edit_requires_reference_no" name="edit_requires_reference_no"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
                                    required>
                                    <option value="1">Yes</option>
                                    <option value="0">No</option>
                            ...
                            <div class="md:col-span-1">
                                <label for="edit_allow_partial_payment"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Allow Partial
                                    Payment*</label>
                                <select id="edit_allow_partial_payment" name="edit_allow_partial_payment"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
                                    required>
                                    <option value="1">Yes</option>
                                    <option value="0">No</option>
                            ...
                            <div class="md:col-span-1">
                                <label for="edit_payment_channel"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Channel*</label>
                                <select id="edit_payment_channel" name="edit_payment_channel"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
                                    required>
                                    {{-- <option selected="">Select product type</option> --}}
                                    <option value="1">Cash</option>
    ...
    <script>
        ...
        function openEditModal(button) {
            ...
            document.getElementById('edit_requires_bank').value = button.getAttribute('data-requires_bank');
            document.getElementById('edit_requires_check').value = button.getAttribute('data-requires_check');
            document.getElementById('edit_requires_reference_no').value = button.getAttribute('data-requires_reference_no');
            document.getElementById('edit_allow_partial_payment').value = button.getAttribute('data-allow_partial_payment');
            document.getElementById('edit_payment_channel').value = button.getAttribute('data-channel');
