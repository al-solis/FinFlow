...
@section('content')
    <div class="p-6 space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900">Currencies</h1>
            ...
            <table class="min-w-full text-xs">
                <thead class="bg-gray-200 text-gray-600">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3 text-left w-[80px]">Symbol</th>
                ...
                <tbody class="divide-y">
                    @forelse($currencies as $currency)
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3 w-[80px]">{{ $currency->code }}</td>
                            <td class="px-4 py-3 w-[150px]">{{ $currency->name }}</td>
                            <td class="px-4 py-3 w-[80px]">{{ $currency->symbol }}</td>
                            <td class="px-4 py-3 w-[100px] text-xs font-semibold">
                                @php
                                    ...
                                    $status = $statuses[$currency->status] ?? [
                            ...
                            <td class="px-4 py-3 w-[50px]">
                                <div class="flex items-center justify-center space-x-2">
                                    <button type="button" title="Edit currency: {{ $currency->name }}"
                                        data-modal-target="edit-modal" data-modal-toggle="edit-modal"
                                        data-id="{{ $currency->id }}" data-name="{{ $currency->name }}"
                                        data-code="{{ $currency->code }}" data-symbol="{{ $currency->symbol }}"
                                        data-status="{{ $currency->status }}" onclick="openEditModal(this)"
                    ...
                    @empty
                        <tr>
                            <td colspan="9" class="px-4 py-6 text-center text-gray-500">
                                <img src="{{ asset('images/no-record.svg') }}" alt="No data"
                                    class="mx-auto mb-4 w-24 h-28">
                                No currencies found. Click here to <a href="#" data-modal-target="add-modal"
                        ...
                        <div class="grid ml-1 mr-1 gap-2 mb-4 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="name" id="name" maxlength="100"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-gray-600 focus:border-gray-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
                                    placeholder="e.g. Philippine Peso" required>
                            </div>

                            <div class="sm:col-span-1">
                                <label for="symbol"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Symbol*</label>
                ...
                <div class="overflow-y-auto max-h-[70vh]">
                    <form id="editForm" class="p-4 md:p-5" method="POST">
                        ...
                        <div class="grid ml-1 mr-1 gap-2 mb-4 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-1">
                                <label for="edit_symbol"
                                    class="block text-xs font-medium text-gray-900 dark:text-white">Symbol*</label>
                                <input type="text" name="edit_symbol" id="edit_symbol" maxlength="10"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-gray-600 focus:border-gray-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
                                    placeholder="e.g. ₱" required>
                            </div>
