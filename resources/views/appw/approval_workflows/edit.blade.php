...
@section('content')
    <div class="mx-auto max-w-5xl" x-data="workflowBuilder()">
        ...
        <form method="POST" action="{{ route('appw.update', $workflow->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="mt-5 mb-5 bg-white rounded-2xl shadow-lg border border-gray-200/80 overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-blue-100">Update workflow configuration for
                                {{ $workflow->moduleLabel() }}</p>
                        </div>
                ...
                <div class="px-8 py-6">
                    ...
                    <div class="relative space-y-4 pl-12">
                        <div class="absolute left-[22px] top-6 bottom-12 w-px bg-gray-200"></div>
                                    ...
                                    <div class="grid grid-cols-1 gap-3 md:grid-cols-12">
                                        <div class="md:col-span-5">
                                            ...
                                            <input type="text" :name="`steps[${index}][step_name]`"
                                                ...
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-gray-600 focus:border-gray-600 block w-full p-2">
                                        </div>
                                        ...
                                        <div class="md:col-span-4">
                                            <label class="mb-1 block text-xs font-medium text-gray-700"
                                                x-text="step.approver_type === 'role' ? 'Role' : 'User'">
                                            </label>
                        ...
                        <button type="button" @click="addStep()"
                            class="block w-full rounded-lg border-2 border-dashed border-gray-300 py-3 text-sm font-semibold text-gray-500 hover:border-blue-500 hover:text-blue-600 transition-colors">
                            + Add another step
                        </button>
                    </div>
                </div>
            ...
            return {
                ...
                init() {
                    ...
                    this.steps = this.steps.map(step => ({
                        ...
                        can_edit_chart_of_account: Boolean(step.can_edit_chart_of_account),
                        can_edit_tax: Boolean(step.can_edit_tax),
                        can_edit_amount: Boolean(step.can_edit_amount),
                        can_return_to_requester: Boolean(step.can_return_to_requester !== undefined ? step
