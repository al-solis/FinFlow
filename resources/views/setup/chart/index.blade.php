...
@section('content')
    <div class="p-6 space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2 mt-0">
                ...
                <a href="{{ route('setup.chart.category.index') }}"
                    class="inline-flex items-center gap-2 px-4 py-2 text-xs font-medium text-white bg-gray-900 rounded-lg hover:bg-gray-800">
                ...
                <a href="{{ route('setup.chart.subcategory.index') }}"
                    class="inline-flex items-center gap-2 px-4 py-2 text-xs font-medium text-white bg-gray-900 rounded-lg hover:bg-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="overflow-y-auto max-h-[70vh]">
                    <form action="{{ route('setup.chart.store') }}" method="POST">
                        @csrf
    ...
    <script>
        ...
        function openEditModal(button) {
            ...
            document.getElementById('editForm').action = `/setup/chart/${id}`;
        }
